---
created: 2026-05-27 06:01
updated: 2026-05-31 21:32
tags: ["synthesis", "obsidian", "pkm"]
---

**Getting Things Done (GTD)** is a work-life management system designed by David Allen. Its core premise is that your brain is for _having_ ideas, not _holding_ them. By offloading tasks and ideas into a trusted external system, you reduce cognitive load and can focus fully on execution.
...
2.  **Clarify:** Process what you captured. Ask: _Is it actionable?_
...
- **[[PARA Method|PARA]] is the Map:** It defines where files and folders live.
...
- **Next Actions:** Physical, immediate next steps that start with a verb (e.g., _Draft_, _Call_, _Email_, _Review_). Keep this list short (1-3 items) to prevent overwhelm.
