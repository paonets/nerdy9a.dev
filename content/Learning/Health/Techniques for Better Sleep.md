...
- **Military Sleep Method / Progressive Muscle Relaxation (เกร็งและผ่อนคลายกล้ามเนื้อ)**
  ...
  - **Process:**
    1. Tense and release facial muscles.
...
- **5-Minute Vagus Nerve Breathing Technique**
  - A 4-step controlled breathing pattern designed to shift the body from sympathetic (stress) to parasympathetic (rest-and-digest) activation (see [[Learning/Concepts/Autonomic Nervous System|Autonomic Nervous System]] & nervous system regulation). Perform each cycle for **6 repetitions**:
    1. **Whoosh/Sigh Exhale:** Inhale through the nose, then exhale through an open mouth with a loud sigh/whoosh to release physical tension.
    2. **Pursed Lip Breathing:** Inhale through the nose, then exhale slowly through pursed lips (like blowing out a candle) to control airflow.
    3. **Box Breathing (4-4-4-4):** Inhale for 4s, hold for 4s, exhale for 4s, hold empty for 4s.
    4. **1:2 Ratio Exhalation:** Inhale through the nose for a set count (e.g., 4s), then exhale through the nose for double that time (e.g., 8s) to stimulate the vagus nerve.
