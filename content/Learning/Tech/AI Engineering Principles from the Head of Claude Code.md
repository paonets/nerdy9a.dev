...
In this episode of _Lenny's Podcast_, Boris Cherny (Head of Claude Code at Anthropic) shares operating principles for building and leading in an AI-first engineering world. He discusses the shift from writing code manually to orchestrating agents via [[Loop Engineering]], emphasizing that constraints on models are counterproductive and that builders should always design for the models of the future.
