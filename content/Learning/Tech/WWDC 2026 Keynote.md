...
- **Device Requirements:**
  - _Standard Siri AI & Apple Intelligence:_ Supported on **iPhone 15 Pro**, **iPhone 15 Pro Max**, or any **iPhone 16 / iPhone 17** (standard models require at least 8GB RAM).
  - _Advanced Features (12GB RAM limit):_ Requires **iPhone 17 Pro**, **iPhone 17 Pro Max**, **iPhone Air**, or newer to run Apple's most powerful on-device model locally. Base models like the standard iPhone 17 (8GB RAM) fallback to **Private Cloud Compute** for these specific features:
  ...
  - _iPads & Macs:_ Requires an **M1 chip or newer** (iPad mini requires A17 Pro or newer).
