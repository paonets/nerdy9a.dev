...
author: Y Combinator
source: https://www.youtube.com/watch?v=gSNFJbgoaHI
date: 2026-06-03
tags: [source/video, tech, ai, software-engineering]
publish: true
created: 2026-06-09 21:30
updated: 2026-06-09 21:30
---
...
![image](attachments/how_to_build_an_ai_native_services_company_sketchnote.webp)
...
1. **Low Trust (Outsourced Budget):** The client already outsources the work and cares about the end product, not how it is made. You step into an existing budget.
2. **Low Judgment at the Task Level:** Steps within the process can be broken down. Most steps must be automated, while human judgment is reserved for specific checkpoints.
3. **High Intelligence Threshold:** The work must be hard enough to require the combination of frontier models and expert humans.
4. **Regulation as a Moat:** Heavily regulated spaces have strict quality bars and accountability, raising barriers to entry (e.g., FDA approvals, mortgage underwriting).
...
1. **Focus on Outcomes:** The transition from selling tools ("co-pilots") to selling outcomes is a major shift in AI business models. Customers want their problems solved, not another software tool to learn.
2. **Rethinking COGS:** For software engineering, viewing human labor as part of COGS (Cost of Goods Sold) requires a change in mindset. The metrics of success shift to operational throughput, cycle time, and variance control.
3. **Quality & Trust:** Trust is built on predictability. In AI pipelines, minimizing variance through deterministic checks, structured outputs, and human evaluations is more critical than raw speed.
