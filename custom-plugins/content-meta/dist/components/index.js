...
var contentMeta_default = '.content-meta-container {\n  margin-top: 0;\n  margin-bottom: 0.5rem;\n}\n\n.content-meta {\n  margin-top: 0;\n  margin-bottom: 0.2rem;\n  color: var(--darkgray);\n}\n.content-meta[show-comma=true] > *:not(:last-child) {\n  margin-right: 8px;\n}\n.content-meta[show-comma=true] > *:not(:last-child)::after {\n  content: ",";\n}\n\n.content-meta-source-line {\n  font-size: 0.9em;\n  color: var(--gray);\n  margin-top: 0.2rem;\n  margin-bottom: 0.5rem;\n}\n.content-meta-source-line .content-meta-link {\n  color: var(--secondary);\n  text-decoration: none;\n  font-weight: 500;\n}\n.content-meta-source-line .content-meta-link:hover {\n  text-decoration: underline;\n}\n.content-meta-source-line .content-meta-separator {\n  color: var(--gray);\n}';
    ...
    if (text) {
      ...
      if (source) {
        ...
        const renderTextWithLinks = (textVal) => {
          ...
          for (const match of textVal.matchAll(WIKILINK_RE)) {
            ...
            innerSegments.push({
              ...
              node: /* @__PURE__ */ u2("a", { href, class: "internal internal-link content-meta-link", children: display })
            });
          }
          for (const match of textVal.matchAll(MDLINK_RE)) {
            ...
            innerSegments.push({
              ...
              node: /* @__PURE__ */ u2(
                ...
                {
                  href: resolvedHref,
                  class: isExternal ? "external external-link content-meta-link" : "internal internal-link content-meta-link",
        ...
        if (Array.isArray(source)) {
          renderedSource = source.map((item, idx) => /* @__PURE__ */ u2(S, { children: [
            idx > 0 && /* @__PURE__ */ u2("span", { class: "content-meta-separator", children: ", " }),
            renderSourceValue(item)
          ] }));
        } else {
          renderedSource = renderSourceValue(source);
        }
        sourceElement = /* @__PURE__ */ u2("div", { class: "content-meta-source-line", children: [
          "Source: ",
          renderedSource
        ] });
      }
      return /* @__PURE__ */ u2("div", { class: classNames(displayClass, "content-meta-container"), children: [
        /* @__PURE__ */ u2("p", { "show-comma": options.showComma, class: "content-meta", children: segments }),
        sourceElement
      ] });
    } else {
      return null;
