...
function renderValue(value, ctx) {
  ...
  if (typeof value === "boolean") {
    return /* @__PURE__ */ u2("span", {
      class: classNames("note-properties-boolean", value ? "is-true" : "is-false"),
      children: /* @__PURE__ */ u2("input", { type: "checkbox", checked: value, disabled: true }),
    });
  }
  ...
  if (typeof value === "object") {
    return /* @__PURE__ */ u2("span", {
      ...
      children: /* @__PURE__ */ u2("code", { children: JSON.stringify(value) }),
    });
  }
  return String(value);
}
