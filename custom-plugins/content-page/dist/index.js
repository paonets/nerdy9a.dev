  ...
  const ContentBody = ({ fileData, tree, allFiles, cfg }) => {
    ...
    const sortPages = (pages) => {
      return [...pages].sort((f1, f22) => {
        ...
        const title2 = f22.frontmatter?.title?.toLowerCase() ?? "";
            ...
            children: [
              ...
              /* @__PURE__ */ u2("div", {
                ...
                children: [
                  ...
                  frontmatter.date &&
                    /* @__PURE__ */ u2("span", {
                      class: "page-cover-date",
                      children: new Date(frontmatter.date).toLocaleDateString("en-US", {
                        year: "numeric",
                        month: "long",
                        day: "numeric",
                      }),
...
// src/pageType.ts
var contentMatcher = ({ slug: slug2 }) => {
  if (slug2.endsWith("/index")) return false;
  if (slug2.startsWith("tags/")) return false;
  return true;
};
var ContentPage = () => ({
  name: "ContentPage",
